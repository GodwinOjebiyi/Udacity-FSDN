# Run this script once to populate the Catalog Database
...
users = [{'email': 'collinsMannis@gmail.com', 'username': 'collins1920'},
         {'email': 'annalamar@gmail.com', 'username': 'annalamar21'}]
